...
def audition(input_filename, output_filename, language_code, sample_rate_hertz):
    stt(input_filename, output_filename, language_code, sample_rate_hertz)

def stt(input_filename, output_filename, language_code, sample_rate_hertz):
...
def execute_cmdline(argv):
    ...
    p.add_argument(     '--input_filename',  default="Markers.csv")
    p.add_argument(     '--output_filename', default="Markers_STT.csv")
